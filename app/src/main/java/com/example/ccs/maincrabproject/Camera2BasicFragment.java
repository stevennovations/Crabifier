...
public class Camera2BasicFragment extends Fragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        this.filename = "crab-" + curtime.getTime() + ".jpg";

        File file = new File(getActivity().getExternalFilesDir(Environment.DIRECTORY_PICTURES), "CrabApp");
        if (!file.mkdirs()) {
            Log.e("TAG", "Directory not created");
        }
        mFile = new File(file, filename);
        Log.d("tag3", mFile.getAbsolutePath());
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            //showToast(getRealPathFromURI(data.getData()));
            String tempFile = getRealPathFromURI(data.getData());
            Intent i = new Intent(getActivity(), ResultActivity.class);
            i.putExtra("crabpic", tempFile);
            startActivity(i);
        }
    }
